...
// SVG icons as separate components for readability
const UsersIcon = () => (
    ...
    <div className="min-h-[calc(100vh-120px)] flex flex-col relative overflow-hidden">
      ...
      <section className="flex-1 flex items-center justify-center px-4 py-12 relative z-10">
        <div className="max-w-2xl mx-auto text-center">
          ...
          {/* Subtitle - Important for SEO */}
          <p className="text-lg text-gray-600 dark:text-gray-400 mb-10 max-w-md mx-auto leading-relaxed">
            {t("app.description")}
          </p>

          {/* Features - minimal but semantic */}
          <ul className="flex flex-wrap justify-center gap-3 mb-10 list-none">
            <li className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-white/80 dark:bg-gray-800/80 text-sm text-gray-700 dark:text-gray-300 shadow-sm border border-gray-100 dark:border-gray-700">
              <UserIcon />
          ...
          {/* CTA */}
          <Button size="lg" onClick={handleEnterApp} className="px-8 shadow-lg shadow-primary-500/20">
            {t("landing.cta")}
            <ArrowIcon />
          </Button>
          ...
          {/* Link to About page - important for SEO internal linking */}
