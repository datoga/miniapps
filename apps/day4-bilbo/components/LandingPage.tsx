  ...
  return (
    <div className="flex min-h-screen flex-col bg-white dark:bg-gray-950">
      ...
      <main className="flex-1">
        {/* Hero Section */}
        <section className="relative overflow-hidden bg-gradient-to-br from-red-50 via-white to-orange-50 dark:from-gray-900 dark:via-gray-950 dark:to-gray-900">
          ...
          {/* Decorative elements */}
          <div className="absolute -left-20 -top-20 h-64 w-64 rounded-full bg-red-200/30 blur-3xl dark:bg-red-900/20" />
          <div className="absolute -bottom-20 -right-20 h-64 w-64 rounded-full bg-orange-200/30 blur-3xl dark:bg-orange-900/20" />
        </section>
        ...
        <section className="border-t border-gray-200 bg-white py-16 dark:border-gray-800 dark:bg-gray-950">
          <div className="mx-auto max-w-6xl px-4">
            ...
            <div className="grid gap-8 sm:grid-cols-2 lg:grid-cols-4">
              ...
              <FeatureCard
                icon="🔄"
                title={t("landing.features.cycles.title")}
                description={t("landing.features.cycles.description")}
              />
              <FeatureCard
                icon="📱"
